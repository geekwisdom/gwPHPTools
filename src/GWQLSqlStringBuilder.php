...
class GWQLSqlStringBuilder implements GWQLCmdBuilderInterface
{
...
if (isset($this->Params)) array_push($this->Params,$value);
else $this->Params[0] = $value;
...
$c=substr($this->commandPart,strlen($this->commandPart)-2,1);
//echo "c is $c\n";
if (substr($this->commandPart,strlen($this->commandPart)-2,1) == ")") $this->commandPart = substr($this->commandPart,0,strlen($this->commandPart)-2);
